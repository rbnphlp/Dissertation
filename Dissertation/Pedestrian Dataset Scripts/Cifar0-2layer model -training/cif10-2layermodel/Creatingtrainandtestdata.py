...
backdoor_folder_path="C:/Users/creem/Dropbox/Dissertation/Dissertation/FinalDataset-Change/pedestrian detection dataset/pedestrian detection dataset/backdoor/input"
...
## Seperating images for backdoor :
	#create_labels(folder_path=backdoor_folder_path,gt_file=backdoor_file)
## seperating the iages for
	#get_index_for_pedestrians(folder_path=backdoor_folder_path,gt_file=backdoor_file)

## Label the images for each of the folder :
#get_index_for_pedestrians(folder_path=image_path_bigfolder[0],gt_file=image_path_bigfolder[1]
...
# Uncomment below to test or train or rename the data
	...
	#create_train_data(backdoor_folder_path)
	#check the size of trian data:

	#print(train_data[0][1])# get the label for the  1st imagefor "backdoor scenario "
	#print(train_data.shape)
	...
	#print(len(train_data[0][0]))# get the array we want  for the 1st image and its label  in "backdoor"
